...
fn = 'DATASET_for_Python_new.xlsx'
...
X = scaled_df_conc.loc[:,["Month","Raw_Flow", "Recycle_Flow", "Temp", "Raw_BOD","Raw_NH3", "Raw_TP","Raw_SP","Raw_TSS","Raw_VSS","Ferric",
              "PE_Flow","PE_BOD","PE_COD","PE_TSS","PE_VSS","PE_SP","PE_fTP", "RAS_Flow","RAS_TSS","Pred_RAS_TSS","MLSS","MLVSS","MLVSS_MLSS",
              "SVI","SRT","SRT_cal","SLBk",'Winter', 'Fall', 'Summer', 'Spring','Mn', 'Ts','Wed','Th','Fr','Sat','Sun',
              't1_TP','t1_TSS', 't1_SP']]
